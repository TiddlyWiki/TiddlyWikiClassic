jQuery(document).ready(function(){
	...
	test("SHA-1 functions", function() {
		...
		actual = Crypto.hexSha1Str("The quick brown fox jumps over the lazy dog").toLowerCase();
		expected = "2fd4e1c67a2d28fced849ee1bb76e7391b93eb12";
		same(actual,expected,'SHA-1 hash of test vector 1 should be correct');

		actual = Crypto.hexSha1Str("abc").toLowerCase();
		expected = "a9993e364706816aba3e25717850c26c9cd0d89d";
		same(actual,expected,'SHA-1 hash of test vector 2 should be correct');

		actual = Crypto.hexSha1Str("abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq");
		expected = "84983E441C3BD26EBAAE4AA1F95129E5E54670F1";
		same(actual,expected,'SHA-1 hash of test vector 3 should be correct');

		actual = Crypto.hexSha1Str("12345678901234567890123456789012345678901234567890123456789012345678901234567890");
